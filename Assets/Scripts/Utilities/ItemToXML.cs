...
{
    [MenuItem("Assets/Inventory/Backup/Make Weapon Database Backup")]
    ...
    static void MakeXMLFromWeaponItems()
    {
        ...
        path += "weapon_database.xml";

        File.WriteAllText(path, xml);
        Debug.Log("weapon_database.xml created!");
    }
    ...
    static string ActionListToString(List<Action> l, string nodeName)
    {
        ...
        foreach (Action a in l)
        {
            ...
            xml += "<overideDamageAnim>" + a.overideDamageAnim + "</overideDamageAnim>" + "\n";
